...
AS
	...
	PRINT 'LINE 1'
	RAISERROR('This is a test RAISERROR (severity = 10; state = 1)', 10, 1);

	PRINT 'LINE 2'
	IF (@UseThrow = 0)
		RAISERROR('This is a test RAISERROR (severity = 16; state = 2)', 16, 2);
	ELSE
		THROW 50001, 'This is a test THROW (severity = 16; state = 2)', 2
			
	PRINT 'LINE 3'
	RAISERROR('This is a test RAISERROR (severity = 10; state = 3)', 10, 3);
